...
namespace NoheasApparel.DataAccessLibrary.Migrations
{
    ...
    [Migration("20240125212500_addRequiredForValidationsssss")]
    partial class addRequiredForValidationsssss
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoheasApparel.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("NoheasApparel.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("NoheasApparel.Models.Gender", b =>
                {
            ...
            modelBuilder.Entity("NoheasApparel.Models.Models.Company", b =>
                {
            ...
            modelBuilder.Entity("NoheasApparel.Models.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("NoheasApparel.Models.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NoheasApparelUserID")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("NoheasApparelUserID");

                    b.ToTable("OrderHeaders");
                });

            modelBuilder.Entity("NoheasApparel.Models.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("NoheasApparel.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NoheasApparel.Models.NoheasApparelUser", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("NoheasApparelUser");
                });
            ...
            modelBuilder.Entity("NoheasApparel.Models.Models.OrderDetail", b =>
                {
                    b.HasOne("NoheasApparel.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NoheasApparel.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("NoheasApparel.Models.Models.OrderHeader", b =>
                {
                    b.HasOne("NoheasApparel.Models.NoheasApparelUser", "NoheasApparelUser")
                        .WithMany()
                        .HasForeignKey("NoheasApparelUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NoheasApparelUser");
                });
            ...
            modelBuilder.Entity("NoheasApparel.Models.Product", b =>
                {
                    b.HasOne("NoheasApparel.Models.Brand", "Brand")
                        .WithMany()
                        .HasForeignKey("BrandID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NoheasApparel.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NoheasApparel.Models.Gender", "Gender")
                        .WithMany()
            ...
            modelBuilder.Entity("NoheasApparel.Models.NoheasApparelUser", b =>
                {
                    b.HasOne("NoheasApparel.Models.Models.Company", "Company")
                        .WithMany()
