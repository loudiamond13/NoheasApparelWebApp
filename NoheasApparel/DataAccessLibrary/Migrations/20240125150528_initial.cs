        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderHeaderID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NoheasApparelUserID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHeaders_AspNetUsers_NoheasApparelUserID",
                        column: x => x.NoheasApparelUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_AspNetUsers_NoheasApparelUserID",
                        column: x => x.NoheasApparelUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, 4, 2, "Olive Strata", "When it's not cold enough for a beanie but you need a little extra protection, this adidas golf hat has you covered. It's made of sturdy twill with an insulated lining to keep you warm during chilly rounds. A moisture-absorbing sweatband keeps you dry and comfortable from first drive to final putt.", "~/content/images/product/adidas_cap_Insulated_Quilted_5-Panel_Hat_Green_HY5996_01_standard_W.jpeg", "Insulated Quilted 5 Panel Hat ", 39.50m },
                    { 2, 2, 4, 3, "Black", "Look effortlessly cool in this adidas bucket hat. Whether you're making a fashion statement or just trying to keep the sun out of your eyes, this polyester hat is ideal for those who value utility as much as style. The best part is, when you're done wearing it you can fold it into its own carrying pouch, complete with a strap.\r\n\r\nMade with a series of recycled materials, and at least 40% recycled content, this product represents just one of our solutions to help end plastic waste.", "~/content/images/product/adidas_cap_Packable_Bucket_Hat_Black_GB4276_06_standard_W.jpeg", "Packable Bucket Hat ", 32.50m },
                    { 3, 2, 4, 1, "Black", "This men's hat has low-key Trefoil style with an embroidered logo on the front. Made of washed canvas, the hat has a crushable, packable design and an adjustable back strap so you can personalize the fit.", "~/content/images/product/adidas_cap_Relaxed_Strap-Back_Hat_Black_BH7139_04_standard_W.jpeg", "Relaxed Strap-Back Hat ", 32.50m },
                    { 4, 2, 4, 1, "White", "This men's hat has low-key Trefoil style with an embroidered logo on the front. Made of washed canvas, the hat has a crushable, packable design and an adjustable back strap so you can personalize the fit.", "~/content/images/product/adidas_cap_Relaxed_Strap-Back_Hat_White_BH7142_04_standard_W.jpeg", "White Relaxed Strap-Back Hat ", 32.50m },
                    { 5, 2, 4, 2, "Linen Green", "This adidas cap works just as well with casual outfits as with workout gear. Subtly embroidered with flowing script, it adds just a touch of sporty detail to your look. It's made with cotton for a soft feel, while the sweatband mops up any moisture to keep you cool and comfortable.", "~/content/images/product/adidas_cap_Saturday_2.0_Plus_Hat_Silver_GB4331_06_standard_W.jpeg", "Saturday 2.0 Plus Hat ", 33.00m },
                    { 6, 2, 4, 1, "Black", "Rain or shine, the trail still calls. Get in your run or make the hike happen in wet weather with this Terrex hat. adidas RAIN.RDY seals out water to keep you running, hiking or exploring — all while keeping your head dry. The seam-sealed design keeps it waterproof, while a moisture-wicking headband keeps sweat out of your face.", "~/content/images/product/adidas_cap_TERREX_RAIN.RDY_Cap_Black_HY3790_01_standard_W.jpeg", "TERREX RAIN.RDY Cap ", 35.00m },
                    { 7, 2, 4, 1, "Blue", "Rain or shine, the trail still calls. Get in your run or make the hike happen in wet weather with this Terrex hat. adidas RAIN.RDY seals out water to keep you running, hiking or exploring — all while keeping your head dry. The seam-sealed design keeps it waterproof, while a moisture-wicking headband keeps sweat out of your face.", "~/content/images/product/adidas_cap_TERREX_RAIN_RDY_Cap_Blue_HY3791_01_standard_W.jpeg", "TERREX_RAIN_RDY Cap ", 35.00m },
                    { 8, 2, 4, 1, "Black", "Fresh adidas Originals style for the streets. This six-panel cap combines a flat brim with a raised Trefoil logo embroidery. A snap-back closure lets you fine-tune the fit.", "~/content/images/product/adidas_cap_Trefoil_Chain_Snap-Back_Cap_Black_standard.jpeg", "Trefoil Chain Snap-Back Cap ", 36.00m },
                    { 9, 2, 4, 1, "Black", "Sunny days are more fun under the brim of this adidas boonie hat. Not only does it shade your eyes, it also steps up your style. A zip pocket and adjustable chin strap seal the deal on utilitarian style. All that's left to do is to grab your towel and head to the beach.", "~/content/images/product/adidas_cap_Utility_Boonie_Hat_Black_GA5295_01_standard_W.jpeg", "Utility Boonie Hat ", 50.00m },
                    { 10, 2, 4, 3, "Shadow Red", "There's nothing more timeless than a classic baseball hat. Throw on this adidas cap and bring some effortless style to any outfit. Its soft fleece build and 3D embroidered Badge of Sport give it that premium touch that elevates your look.", "~/content/images/product/adidas_cap_Wool_Baseball_Hat_Burgundy_IJ7300_01_standard_W.jpeg", "Wool Baseball Hat ", 20.00m },
                    { 11, 2, 2, 1, "Black", "Got a cold-weather round in store? Game on. Pull on this adidas golf hoodie and you won't give the temperature a second thought. It's made with COLD.RDY that traps heat against the body to keep you warm in chilly conditions. Soft fleece feels extra cosiness against your skin, and a bungee-adjustable hem lets you seal out cool air. When light rain hits, you'll stay dry thanks to the water-repellent finish.", "~/content/images/product/adidas_COLD_RDY_Hoodie_Black_IL9632_21_mens.jpeg", "COLD RDY Hoodie ", 71.00m },
                    { 12, 2, 2, 1, "Black/White", "When they go loud, you go low-key. This adidas hoodie has plenty of understated appeal. Made from cotton-blend fleece, it keeps you warm from your head to your hands, thanks to the adjustable hood and the cozy front pocket. 3-Stripes at the shoulders add a classic touch.", "~/content/images/product/adidas_Essentials_Fleece_3-Stripes_Full-Zip_Hoodie_Black_IB4029_21_mens.jpeg", "Essentials Fleece 3-Stripes Full-Zip Hoodie ", 45.00m },
                    ...
                    { 14, 2, 2, 1, "Black", "An everyday essential with an eye-catching graphic. The comfortable loose fit, French terry construction and classic silhouette make this adidas hoodie an instant go-to. Trefoil logos on the front and back get an elemental update with photorealistic water droplets that'll have passersby doing a double take.", "~/content/images/product/adidas_Graphic_Liquid_Trefoil_Hoodie_Black_II8170_21_mens.jpeg", "Graphic Liquid Trefoil Hoodie ", 62.00m },
                    { 15, 2, 2, 3, "Black", "Whether it's chilly out or you just feel like hanging at home, this adidas hoodie lets you make the most out of a cold day. It's made of soft, heavyweight French terry fabric to keep you warm, and it's styled to be worn by all genders. The loose fit gives you a relaxed feel, so you can lounge around comfortably all day long.", "~/content/images/product/adidas_Lounge_Heavy_French_Terry_Hoodie_Black_IC4084_25_mens.jpeg", "Lounge Heavy French Terry Hoodie ", 99.00m },
                    { 16, 2, 2, 1, "Arctic Night", "Stand out from tee to green in this adidas golf sweatshirt. Soft polar fleece gives a luxe feel while keeping you cozy on the course during chilly weather. Ribbed cuffs and hem seal out the cold, and a durable water-repellent finish keeps you dry through misty rounds and occasional light showers.", "~/content/images/product/adidas_Oasis_Crew_Sweatshirt_Turquoise_IB1982_21_mens.jpeg", "Oasis Crew Sweatshirt Turquoise ", 99.00m },
                    { 17, 2, 2, 1, "Bright Red", "Chilly weather calls for a lightweight layer. This adidas golf pullover is made of soft knit for comfort on the course. Moisture-absorbing AEROREADY keeps you dry, and built-in UV coverage lets you play with confidence on sunny days.", "~/content/images/product/adidas_Quarter-Zip_Pullover_Red_IJ0185_25_mens.jpeg", "Quarter-Zip Pullover ", 47.00m },
                    { 18, 2, 2, 1, "Blue / White", "Sometimes less is more. The adidas Trefoil Essentials crewneck perfects effortless style and timeless design. An embroidered Trefoil adorns the clean silhouette. Made for everyday casual wear, this crewneck serves laid-back vibes with a simple yet bold look.", "~/content/images/product/adidas_Trefoil_Essentials_Crewneck_Blue_IR7781_21_mens.jpeg", "Trefoil Essentials Crewneck ", 41.00m },
                    { 19, 2, 2, 1, "Black", "Whether you're on the mat in the studio or at home, this super-soft adidas sweatshirt lets you breathe easily. Perfect your poses in its free-flowing design, detailed with a hood, a zip pocket and shaped cuffs. In the mood for hot yoga? AEROREADY manages moisture so you can keep your focus. The back relays a message to remember: Allow yourself to grow.", "~/content/images/product/adidas_Yoga_Training_Hooded_Sweatshirt_Black_IN7922_21_mens.jpeg", "Yoga Training Hooded Sweatshirt ", 51.00m },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHeaders_NoheasApparelUserID",
                table: "OrderHeaders",
                column: "NoheasApparelUserID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_NoheasApparelUserID",
                table: "ShoppingCarts",
                column: "NoheasApparelUserID");
